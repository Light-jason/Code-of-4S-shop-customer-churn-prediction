...
for k = 1:10
    ...
    [~,~,probs_of_positive,~,final_loss,time_consume] = Logistic_Regression(x_train,y_train,x_test,y_test);
...
RESULT_of_LR{3} = confuse_matrix; RESULT_of_LR{4} = error_rate_of_TestSet;
RESULT_of_LR{5} = cross_entropy; RESULT_of_LR{6} = TimeConsume; 

save('RESULT_of_LR.mat','RESULT_of_LR')
